...
<head>
    ...
    <link href="${pageContext.servletContext.contextPath}/css/style.css" rel="stylesheet"
          type="text/css">
    <script src="${pageContext.servletContext.contextPath}/js/withdrawals.js" type="text/javascript"></script>
...
<div id="keypad"  class="keybord">
    <h4 style="color: #528ECC; text-align: center ">Amount to withdrawal:</h4>
    <form action="${pageContext.servletContext.contextPath}/Withdrawals" method="post"  >
